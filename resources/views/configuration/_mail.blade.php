			<div class="col-sm-6">
			  ...
			  <div class="form-group">
				...
				{!! Form::input('email','from_address',(config('mail.from.address')) ? : 'support@wmlab.in',['class'=>'form-control','placeholder'=>'Enter From Address'])!!}
			  </div>
			  <div class="form-group">
			    {!! Form::label('from_name','From Name',[])!!}
				{!! Form::input('text','from_name',(config('mail.from.name')) ? : 'WM Lab',['class'=>'form-control','placeholder'=>'Enter From Name'])!!}
			  </div>
